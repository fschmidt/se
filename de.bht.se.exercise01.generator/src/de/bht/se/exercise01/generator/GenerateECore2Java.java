...
/**
 * Entry point of the 'GenerateECore2Java' generation module.
 *
 * @generated
 */
public class GenerateECore2Java extends AbstractAcceleoGenerator {
	/**
  ...
  /**
	 ...
	 * @generated
	 */
	public GenerateECore2Java(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateECore2Java(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateECore2Java generator = new GenerateECore2Java(modelURI, folder, arguments);
