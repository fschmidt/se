...
public class UidSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UidPackage.UN_VISIBELE_ASSOC: {
				unVisibeleAssoc unVisibeleAssoc = (unVisibeleAssoc)theEObject;
				T result = caseunVisibeleAssoc(unVisibeleAssoc);
				if (result == null) result = caseIEAssoc(unVisibeleAssoc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>un Visibele Assoc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>un Visibele Assoc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseunVisibeleAssoc(unVisibeleAssoc object) {
		return null;
	}
