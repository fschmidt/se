...
/**
 * This is the item provider adapter for a {@link uid.App} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AppItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UidPackage.Literals.APP__HAS);
			childrenFeatures.add(UidPackage.Literals.APP__HAS_IE);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.APP__HAS,
				 UidFactory.eINSTANCE.createIEAssoc()));
